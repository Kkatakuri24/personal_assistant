...
#stock functions
output_file.write("Hi Josh," + os.linesep)
output_file.write("Today is " + current_time.strftime("%a %Y-%m-%d %H:%M") + os.linesep)
output_file.write("---Start of Stock report Session--------------------" + os.linesep)
...
for job_elem in job_elems:
    ...
    output_file.write(title_elem.text.strip() + os.linesep)
    output_file.write(company_elem.text.replace('\n','') + os.linesep)
    output_file.write(summary_elem.text.strip()  + os.linesep)
    output_file.write("<==========End of one job==========>" + os.linesep)
